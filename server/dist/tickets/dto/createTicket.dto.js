...
], CreateTicketDto.prototype, "platformId", void 0);
__decorate([
    (0, class_validator_1.IsUUID)(4, { message: "Должно быть формата UUID" }),
    __metadata("design:type", String)
...
__decorate([
    (0, class_validator_1.IsUUID)(4, { message: "Должно быть формата UUID" }),
    __metadata("design:type", String)
], CreateTicketDto.prototype, "curatorId", void 0);
__decorate([
    (0, class_validator_1.IsUUID)(4, { message: "Должно быть формата UUID" }),
    __metadata("design:type", String)
], CreateTicketDto.prototype, "certificateId", void 0);
__decorate([
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsArray)({ message: "Должно быть массивом" }),
    __metadata("design:type", Array)
], CreateTicketDto.prototype, "students", void 0);
